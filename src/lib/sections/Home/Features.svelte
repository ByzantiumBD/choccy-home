...
<div id="Features" class="allcenter mt-[100px] flex-col text-white">
	<span class="py-1 px-3 text-sm mb-2 gradient bordered"> Features </span>
	<h1
	...
	<span class="text-lg text-center max-w-[17cm] px-3 text-[var(--text-transparent)]">
