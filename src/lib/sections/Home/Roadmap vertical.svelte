...
<div id="Roadmap" class="min-[1201px]:!hidden allcenter mt-[150px] flex-col text-white mb-[250px]">
	...
	<div id="scrollbox" class="mt-6 w-screen h-[22cm] relative overflow-clip">
			...
			<div bind:clientHeight={cH} id="completed">
				<div>
					<span class="floating-span top-0 w-1/2" style:--offset="35mm">
						<h3 class="text-xl font-extrabold text-[var(--lilac)]">First version release</h3>
						<p class="text-sm text-[var(--text-transparent)]">
					...
					<span class="floating-span top-1/4 w-1/2" style:--offset="53mm">
						<h3 class="text-xl font-extrabold text-[var(--lilac)]">FT4 update</h3>
						<p class="text-sm text-[var(--text-transparent)]">
					...
					<span class="floating-span top-1/2 w-1/2" style:--offset="31mm">
						<h3 class="text-xl font-extrabold text-[var(--lilac)]">Website & branding update</h3>
						<p class="text-sm text-[var(--text-transparent)]">
					...
					<span class="floating-span top-3/4 w-1/2" style:--offset="25mm">
						<h3 class="text-xl font-extrabold text-[var(--lilac)]">Liquidity Deals</h3>
						<p class="text-sm text-[var(--text-transparent)]">
			...
			<div bind:clientHeight={prH} id="in-progress">
				<div>
					<span class="floating-span top-0 w-1/2" style:--offset="49mm">
						<h3 class="text-xl font-extrabold text-[var(--lilac)]">Orderbook implementation</h3>
						<p class="text-sm text-[var(--text-transparent)]">
					...
					<span class="floating-span top-1/4 w-1/2" style:--offset="42mm">
						<h3 class="text-xl font-extrabold text-[var(--lilac)]">Performance test</h3>
						<p class="text-sm text-[var(--text-transparent)]">
					...
					<span class="floating-span top-1/2 w-1/2" style:--offset="18mm">
						<h3 class="text-xl font-extrabold text-[var(--lilac)]">User onboarding</h3>
						<p class="text-sm text-[var(--text-transparent)]">
					...
					<span class="floating-span top-3/4 w-1/2" style:--offset="16mm">
						<h3 class="text-xl font-extrabold text-[var(--lilac)]">Launchpad implementation</h3>
						<p class="text-sm text-[var(--text-transparent)]">
			...
			<div bind:clientHeight={sH} id="scheduled">
				<div>
					<span class="floating-span top-0 w-1/2" style:--offset="31mm">
						<h3 class="text-xl font-extrabold text-[var(--lilac)]">Liquidity provision</h3>
						<p class="text-sm text-[var(--text-transparent)]">
					...
					<span class="floating-span top-1/2 w-1/2" style:--offset="38mm">
						<h3 class="text-xl font-extrabold text-[var(--lilac)]">Subscription model</h3>
						<p class="text-sm text-[var(--text-transparent)]">
			...
			<div bind:clientHeight={plH} id="planned">
				<div>
					<span class="floating-span top-0 w-1/2" style:--offset="45mm">
						<h3 class="text-xl font-extrabold text-[var(--lilac)]">Metamask integration</h3>
						<p class="text-sm text-[var(--text-transparent)]">
					...
					<span class="floating-span top-1/3 w-1/2" style:--offset="38mm">
						<h3 class="text-xl font-extrabold text-[var(--lilac)]">Oracles</h3>
						<p class="text-sm text-[var(--text-transparent)]">
					...
					<span class="floating-span top-2/3 w-1/2" style:--offset="16mm">
						<h3 class="text-xl font-extrabold text-[var(--lilac)]">Sharding</h3>
						<p class="text-sm text-[var(--text-transparent)]">
